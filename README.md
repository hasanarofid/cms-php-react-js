# Feylla Beauty Salon and Spa CMS

Sistem Content Management System (CMS) untuk website Feylla Beauty Salon and Spa. Dibangun dengan **PHP Backend** dan **React Frontend** menggunakan teknologi modern.

## 👨‍💻 Pengembang

**Hasan Arofid**  
GitHub: [@hasanarofid](https://github.com/hasanarofid)  
Repository: [cms-ecommerce](https://github.com/hasanarofid/cms-ecommerce)

## 📋 Deskripsi Proyek

CMS ini dirancang khusus untuk mengelola konten website salon, termasuk:
- **Manajemen Konten**: Halaman, Postingan (Berita/Promosi), Kategori
...
Proyek ini dikembangkan untuk Feylla Beauty Salon and Spa.
