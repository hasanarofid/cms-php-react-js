...
const sliderSchema = z.object({
  ...
  image: z.string().optional(), // Make image optional initially
  ...
  if (!data.image && !data.videoUrl && !data.videoFile) {
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      message: 'Setidaknya salah satu dari Gambar, Video File, atau URL YouTube wajib diisi',
      path: ['image'], // Attach error to image field, or a more general field if available
    });
    ctx.addIssue({
      code: z.ZodIssueCode.custom,
      message: 'Setidaknya salah satu dari Gambar, Video File, atau URL YouTube wajib diisi',
