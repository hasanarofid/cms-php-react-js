      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-accent text-primary-900 py-3 px-4 rounded-xl font-bold hover:bg-accent-dark transition-all shadow-lg shadow-accent/20 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
          >
